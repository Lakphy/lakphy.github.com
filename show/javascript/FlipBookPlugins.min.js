!(function(t, e, n, o) {
            ...
            return (
                ...
                (e.prototype.start = function() {
                    ...
                    if (t && t.src) {
                        ...
                        this.audioAutoPlay &&
                            this.visible &&
                            ((this.audioAutoPlay = !1), e.play());
                    }
                }),
                (e.prototype.addLoadItem = function(t, e) {
                    this.loadList.push({ id: t, cb: e });
                }),
                            ...
                            function() {
                                if (!t.destroyed) {
                                    ...
                                    n >= 0 &&
                                        (e.splice(n, 1),
                                            0 === e.length &&
                                            (t.onloadTimeout = setTimeout(function() {
                                                t.onload();
                                            }, 1e3)));
                                }
                            },
        ...
        c.addMenuIcon("Audio", function(t) {
            ...
            if (i && i.src) {
                var s = "menu__audio--muted",
                    a = "menu__audio--sound";
                i.autoplay ?
                    o.data("paused", !1).addClass(a) :
                    o.data("paused", !0).addClass(s);
                var r;
                o.on("click", function() {
                    var t = e.audio,
                        i = o.data("paused");
                    t.ended && (t.currentTime = 0),
                        ...
                        (t.currentTime ?
                            (r = n.audioFadeIn(t)) :
                            ((t.volume = 1), t.play()),
                            o.data("paused", !1).addClass(a).removeClass(s)) :
                        ((r = n.audioFadeOut(t)),
        ...
        function i(e) {
            ...
            for (
                var i,
                    ...
                    c,
                    u = e.plugins,
                    h = (this.components, n(e.container)),
                    f = 0;
                (i = u[f++]);
        ...
        return (
            ...
            (i.prototype.dragable = function(t) {
                ...
                t.on(
                        ...
                        ".dragable",
                        (this.dragDownHandler = function(t) {
                            c = !0;
                    ...
                    h.on(
                        ...
                        (this.dragEndHandler = function(t) {
                            (c = !1),
                            d && (u && u.end && u.end(t), (g = !1), y.remove(), (d = !1));
                        })
                    );
            }),
            (i.prototype.undragable = function() {
                ...
                n(t)
                    .off("mousedown dbclick", this.stopPropagationHandler)
                    .off("mousedown touchstart", this.dragDownHandler),
            ...
            (i.prototype.show = function() {
                for (var t, e = 0, n = this.components;
                    (t = n[e++]);) t.show();
            }),
            ...
            (i.prototype.destroy = function() {
                for (var e, o = 0, i = this.components;
                    (e = i[o++]);) e.destroy();
                ...
                (o.prototype.init = function() {
                    var t = this,
                        ...
                        p = n(d).click(function() {
                            d.duration &&
                                (d.paused ?
                                    (a.removeClass("stop").addClass("play"), d.play()) :
                                    (a.removeClass("play").addClass("stop"), d.pause()),
                                    a
                                    .stop(!0, !0)
                    ...
                    var w,
                        ...
                        T =
                        (n("<span>").addClass("separator").appendTo(k).text(" / "),
                            n("<span>").addClass("total").appendTo(k).text("00:00")),
                        x =
                        (i("fullscreen")
                            .appendTo(r)
                            .click(function() {
                        ...
                        E =
                        (i("progress-padding").appendTo(I),
                            i("progress-bar").appendTo(I)),
                    ...
                    p.on("pause", function() {
                        ...
                        p.on("volumechange", function() {
                            ...
                            g.css("width", e),
                                _.css("left", e),
                                0 === t ?
                                m.removeClass("unmuted").addClass("muted") :
                                m.removeClass("muted").addClass("unmuted");
                        });
                    var S = function(t) {
                        var e = ~~(t / 3600),
                            n = ~~((t % 3600) / 60),
        ...
        f = (function(t) {
            function e(e) {
                ...
                /^((?!chrome).)*safari/i.test(navigator.userAgent) &&
                    o.css({ webkitOverflowScrolling: "touch", overflow: "scroll" });
            }
            return (
                p(e, t),
                (e.prototype.start = function() {
                ...
                (e.prototype.parseCode = function(t) {
                    for (
                        var e, o = n("<div>").html(t)[0], i = o.childNodes, s = 0, a = 0;
                        (e = i[s++]);
        ...
        return (
            ...
            (e.prototype.init = function() {
                for (
                    var t,
                        ...
                        d = this.node,
                        p = n("<input>")
                        .addClass("linklist__title dragable")
                        .val(a.content)
                        .attr("disabled", !0)
                        .css(a)
                        .appendTo(d),
                        ...
                        u = l - c - 2,
                        h = n("<ul>").appendTo(
                            n("<div>").addClass("linklist__body").appendTo(d).css("height", u)
                        ),
                        f = r.content,
                        v = 0;
                    (t = f[v++]);
                    ...
                    (o.attr("title", t.link),
                        e.append(
                            n("<a>")
                            .attr({ href: t.link, target: "_blank" })
                            .append(o)
                            .css(r)
                        )) :
                    e.append(o.css(r)),
            ...
            (e.prototype.bindDragEvent = function() {
                ...
                o.addClass("dragable").data("dragable", {
                    ...
                    move: function(e, n) {
                        ...
                        e.scrollingAnimation || n(i).animate({ top: 15 }, 200);
                    },
                });
            }),
            (e.prototype.checkScroll = function() {
                ...
                this.scrollingAnimation &&
                    (this.scrollingAnimation.stop(), (this.scrollingAnimation = null));
                var e,
                    o = this.node,
            ...
            (e.prototype.enter = function() {
                var t = this,
                    e = this.node.find(".linklist__title").css({ width: 0, opacity: 0 }),
                    n = this.node.find(".linklist__body");
                n.slideUp(0, function() {
                    t.node.css("opacity", t.options.opacity || 1),
                        e.animate({ width: "100%", opacity: 1 }, 300, function() {
            ...
            (e.prototype.destroy = function() {
                t.prototype.destroy.call(this),
                    this.scrollingAnimation &&
                    (this.scrollingAnimation.stop(!0, !1),
    ...
    l.register("linklist", m),
        m.addMenuIcon("Scroll", function(t) {
            ...
            s.addClass(o).click(function() {
                (e.paused = !e.paused),
                e.paused ?
                    s.removeClass(o).addClass(i) :
                    s.removeClass(i).addClass(o);
            });
        });
    var y = (function(e) {
        function o(t) {
        ...
        return (
            ...
            (o.prototype.init = function() {
                var t = this,
                    ...
                    i = e.width(),
                    s = e.height();
                e.css({ lineHeight: s + "px" });
                var a = n("<div>")
                    .addClass("newsticker__title")
                    .css(o.title)
                    .appendTo(e);
                o.title ? a.html(o.title.content) : a.hide();
                var r = n("<div>")
                    .addClass("newsticker__body")
                    .appendTo(e)
                    .css(o.content),
                ...
                if (o.controls) {
                    ...
                    var c =
                        (n("<i>")
                            .addClass("newsticker__controls--previous")
                            .appendTo(l)
                            .click(function() {
                                t.prev();
                            }),
                        ...
                        h = n("<i>")
                        .addClass(o.autoplay ? u : c)
                        .appendTo(l)
                        .click(function() {
                            t.paused ?
                                (t.play(), h.addClass(u).removeClass(c)) :
                                (t.pause(), h.addClass(c).removeClass(u));
                        });
                    n("<i>")
                        .addClass("newsticker__controls--next")
                        .appendTo(l)
                        .click(function() {
                            t.next();
                        });
            ...
            (o.prototype.play = function() {
                ...
                if (((this.paused = !1), !this.animation)) {
                    var e,
                        ...
                        i = !1;
                    if (
                        ((this.animation = n({ a: 0 }).animate({ a: 1 }, {
                                duration: 31536e3,
                                easing: "linear",
                                queue: !1,
                                step: function() {
            ...
            (o.prototype.getNewsItem = function(e) {
                var o = this.options.news[e],
                    i = o.title || o.content,
                    s = n("<div>")
                    .addClass("newsticker__body--content")
                    .appendTo(this.transitionContainer)
                    .attr({ target: "_blank", title: i })
                    .html(i);
                return (
                    o.link &&
                    s
                    ...
                    .hover(
                        function() {
                            s.css({ textDecoration: "underline" });
                        },
                        function() {
                            s.css({ textDecoration: "none" });
                        }
                    ),
                    s
                );
            ...
            (o.prototype.fade = function(t, e, n, o) {
                ...
                this.prevTarget && this.prevTarget.remove(),
                    e &&
                    e.stop().fadeOut(i, function() {
                        this.remove();
                    }),
                    n
                    .css("opacity", 0)
                    .delay(i)
                    .animate({ opacity: 1 }, i, function() {
                        o();
                    });
            }),
            (o.prototype.slide = function(t, e, n, o) {
                ...
                this.prevTarget && this.prevTarget.remove(),
                    ...
                    .delay(i)
                    .animate({ left: 0, opacity: 1 }, i, function() {
                        o();
                    });
            }),
            ...
            (o.prototype.tick = function(t, e, n, o) {
                var i = this.duration,
                    ...
                    a = "100%";
                e &&
                    e.stop().animate({ top: t ? a : s }, i, function() {
                        this.remove();
                    }),
                    n.css("top", t ? s : a).animate({ top: "0" }, i, function() {
                        o();
                    });
            }),
            (o.prototype.erase = function(t, e, n, o) {
                ...
                this.prevTarget && this.prevTarget.remove(),
                    e &&
                    e.stop().animate({ height: 0 }, i, function() {
                        this.remove();
                    }),
                    n
                    .height(0)
                    .delay(i)
                    .animate({ height: "100%" }, i, function() {
                        o();
                    });
            }),
            o
        ...
        return (
            ...
            (e.prototype.init = function() {
                for (
                    var t,
                        ...
                        r = this.options,
                        d = r.slides,
                        p = n("<ul>").addClass("slide--pages").appendTo(a),
                        l = n("<div>").addClass("slide--title").appendTo(a),
                        c = n("<ul>").addClass("slide--thumbnails").appendTo(a),
                        u = this.width,
                        h = this.height,
                        f = function(t, e) {
                            (s.imageSize[e] = {
                    ...
                    i.link ?
                    n("<a>")
                    .attr({ href: i.link, target: "_blank", title: i.link })
                    .append(e)
                    .appendTo(t) :
                    t.append(e),
                ...
                c &&
                    ((o = c.width),
                        ...
                        ((r = t.offsetWidth),
                            ...
                            (l = (a - d) / 2)) :
                        o / i > s / a ?
                        ((r = s), (d = (i / o) * s), (p = 0), (l = (a - d) / 2)) :
                        ((r = (o / i) * a), (d = a), (p = (s - r) / 2), (l = 0)),
                        n(t).css({ width: ~~r, height: ~~d, left: ~~p, top: ~~l }));
            }),
            (e.prototype.resize = function() {
                var t = this;
                (this.width = this.node.width()),
            ...
            (e.prototype.autoskip = function() {
                ...
                this.animation = n({ a: 0 }).animate({ a: 1 }, {
                    ...
                    step: function() {
                        ...
                        !i && !e.paused && 300 > s ?
                            ((e.count += s),
                                e.count >= e.interval && e.skip(e.currentIndex + 1)) :
                            (e.count = 0),
                            (t = n);
                    },
                });
            ...
            (e.prototype.skip = function(t) {
                ...
                var n = e[t],
                    ...
                    (this.node
                        .find(".slide--pages")
                        .css("transform", "translateX(" + this.width * -t + "px)"),
            ...
            (e.prototype.enter = function() {
                var t = this,
                    e = this.node
                    .css("opacity", this.options.opacity || 1)
                    .find(".slide--title")
                    .css("bottom", "-40px"),
                    o = this.node
                    .find(".slide--thumbnails li")
                ...
                o.each(function(o, s) {
                    n(s)
                        ...
                        .animate({ left: 0, opacity: 1 }, 300, function() {
                            0 === o &&
                                e.animate({ bottom: 0 }, 300, function() {
                                    t.start();
                                });
                        });
                });
        ...
        _.addMenuIcon("Autoskip", function(t) {
            ...
            o.addClass(this.options.autoplay ? i : s),
                o.click(function() {
                    (e.paused = !e.paused),
                    e.paused ?
                        o.addClass(s).removeClass(i) :
                        o.addClass(i).removeClass(s);
                });
        }),
    ...
    var C = (function(e) {
        function o(t) {
            e.call(this, t);
            for (
                var n, o, i = this.node.addClass("ticker"), s = this.options.rss, a = 0;
                (n = s[a++]);

            )
                (o = this.creatItem(n)), i.append(o);
        }
        return (
            p(o, e),
            (o.prototype.creatItem = function(e) {
                var o = n(
                        '<div class="ticker__item"><img class="item__img"src="' +
                        e.src +
                        '""><div class="item__text"><p class="text__title">' +
                        e.title +
                        '</p><p class="text__content">' +
                        e.content +
                        '</p></div><div class="clear"></div></div>'
                    ),
                    i = this.options;
                return (
                    o.find(".text__title").css(i.title),
                    o.find(".text__content").css(i.content),
                    o.css("backgroundColor", i.style.backgroundColor).hover(
                        function() {
